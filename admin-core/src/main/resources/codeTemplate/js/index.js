    ...
    var view ={
        ...
        initTable:function(){
            ${entity.code}Table = table.render({
                ...
                cellMinWidth: 100,
                method : 'post',
                url : Common.ctxPath + '/${target.urlBase}/${entity.code}/list.json' // 數據接口
            ...
            @if(attr.name=="delFlag" || !attr.displayInTable){continue;}
                    @if(attr.name=="version"){continue;}
                    @if(attr.name=="attachmentId"){continue;}
                {

                    field : '${isEmpty(attr.dictType)?attr.name:(attr.name+"Text")}', ${isNotEmpty(attr.dictType)?"//數據字典類型為 "+attr.dictType}
        ...
        initToolBar:function(){
            toolbar = {
                ...
                edit : function() { // 獲取選中數目
                    ...
                    Common.openDlg(url,"${entity.displayName}管理>"+data.${entity.nameAttribute.name}+">編輯");
                },
                del : function() {
            ...
            ,
                exportDocument : function() {
                    layui.use([ '${entity.code}Api' ], function() {
                        ...
                        Common.openConfirm("確認要導出這些${entity.displayName}數據?", function() {
                ...
                importDocument:function(){
                    ...
                    Common.openDlg(url, "${entity.displayName}管理>上載");
                }
                @}
        };
