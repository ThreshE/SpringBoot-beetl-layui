...
public class MVCConf implements WebMvcConfigurer, InitializingBean {
    ...
    public static final String DEFAULT_APP_NAME = "開發平臺";
    private static final String[] EXCLUDE_PATHS = {"/static/**","/js/**","/css/**","/font/**","/plugins/**","/","/login.do","/goddess/appUser/**","/goddess/orderApp/**"};

    /**
     * 係統名稱,可以在application.properties中配置
     * app.name=xxx
     */
//    @Value("${app.name}")
//    String appName;
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(new SessionInterceptor(httpRequestLocal, this))
                .addPathPatterns("/**")
...
class SessionInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        if (request.getSession().getAttribute(CorePlatformService.ACCESS_CURRENT_USER) == null){
